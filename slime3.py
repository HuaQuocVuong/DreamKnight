...
from slime3_animation import Slime3AnimationLoader

# ================================================================================================
# CLASS SLIME3 — Kẻ địch Slime 3 (nhanh nhất, luôn đuổi theo player)
# ================================================================================================
...
class Slime3(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, scale_factor=2.0):
        """
        Khởi tạo Slime3 với đầy đủ animation, AI, máu, âm thanh
        x, y: vị trí spawn
        ...
        all_anims = Slime3AnimationLoader.load_all(scale_factor)
        ...
        # Hệ số tốc độ — Slime3 nhanh nhất trong các loại slime
    ...
    def _load_sounds(self):
        ...
        try:
            ...
            print(f"[Slime3] Lỗi load âm thanh: {e}")
    ...
    def take_damage(self, damage) -> bool:
        ...
        self.health -= damage
        print(f"[Slime3] Nhận {damage} sát thương! Máu còn: {self.health}/{self.max_health}")
    ...
    def _start_attack(self, current_time):
        ...
        print(f"[Slime3] Bắt đầu tấn công (dist <= {self.attack_range}px)")
