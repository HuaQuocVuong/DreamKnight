...
class Slime2(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, scale_factor=2.0):
        ...
        self.run_speed_multiplier = 0.45   # Hệ số tốc độ chạy (Slime2 nhanh hơn Slime1)
        self.walk_speed_multiplier = 0.35  # Hệ số tốc độ đi bộ
