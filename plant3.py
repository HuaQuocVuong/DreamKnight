...
# ================================================================================================
# CLASS PLANT3 — Kẻ địch Plant 3 (nhiều máu, sát thương cao, luôn đuổi theo player)
# ================================================================================================
...
class Plant3(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, scale_factor=2.0):
        """
        Khởi tạo Plant3 với animation, AI, máu, âm thanh
        x, y: vị trí spawn
        ...
        # Hệ số tốc độ — nhanh nhất, ngang Slime3
    ...
    def update(self, delta_time, map_width, map_height):
        ...
        if self.state == "return_home":
            self._handle_return_home(home_cx, home_cy)  # Quay về home (nếu có)
    ...
    def draw(self, screen, camera):
        ...
        pygame.draw.circle(screen, (0, 100, 0), (cx, cy), self.body_radius, 2)
